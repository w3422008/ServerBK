                    ...
                    <tr>
                        ...
                        <td>            
                            ...
                            <?php if($var['adm_user'] === '1'){ ?>
                                <label class="uk-label uk-label-danger"><?php echo "管理者"; ?></label>
                            <?php }elseif($var['adm_user'] === '0'){ ?>
                                <label class="uk-label uk-label-success"><?php echo "一般"; ?></label>
                            <?php }elseif($var['adm_user'] === '2'){ ?>
                                <label class="uk-label uk-label-primary"><?php echo "一般（事務）"; ?></label>
                            <?php };?>
                        </td>
                        <td>
                            <div>
